...
# nets 需要从https://github.com/tensorflow/models.git
# 下载，解压后，在models-master\research\slim\nets目录，可将其拷贝到与本程序相同的目录下即可
...
BATCH_SIZE = 25
# tfrecord文件存放路径
TFRECORD_FILE = "../tf_out/captcha_tfrecord/train.tfrecords"
...
with tf.Session() as sess:
    ...
    for i in range(6001):
        ...
        if i % 20 == 0:  
            ...
            if i==6000:
                saver.save(sess, "../tf_out/captcha_models/crack_captcha.model", global_step=i)
                break 
